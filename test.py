...
if __name__ == '__main__':
    ...
    model_configurations = [
        ("fold4_b1", os.path.join(project_base_path, "PANDA_models_fold4_model_efficientnet_b1/best_model_efficientnet_b1_0.9442.pth"), 'efficientnet_b1'),
        ("fold2_b1", os.path.join(project_base_path, "PANDA_models_fold2_model_efficientnet_b1/best_model_efficientnet_b1_0.9483.pth"), 'efficientnet_b1'),
        ("fold1_b1", os.path.join(project_base_path, "PANDA_models_fold1_model_efficientnet_b1/best_model_efficientnet_b1_0.9374.pth"), 'efficientnet_b1'),
        ("fold0_b1_v2", os.path.join(project_base_path, "PANDA_models_fold0_model_efficientnet_b1/best_model_efficientnet_b1_v2_0.9360.pth"), 'efficientnet_b1'),
